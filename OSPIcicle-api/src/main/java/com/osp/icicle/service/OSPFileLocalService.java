...
public interface OSPFileLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OSPFileLocalServiceUtil} to access the osp file local service. Add custom service methods to <code>com.osp.icicle.service.impl.OSPFileLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public OSPFile addOSPFile(OSPFile ospFile);
	...
	public OSPFile createOSPFile(long ospFileId);
	...
	public OSPFile deleteOSPFile(long ospFileId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public OSPFile deleteOSPFile(OSPFile ospFile);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OSPFile fetchOSPFile(long ospFileId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OSPFile getOSPFile(long ospFileId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public OSPFile updateOSPFile(OSPFile ospFile);
