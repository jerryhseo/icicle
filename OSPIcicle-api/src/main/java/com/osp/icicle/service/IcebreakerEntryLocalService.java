...
/**
 * Provides the local service interface for IcebreakerEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see IcebreakerEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface IcebreakerEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IcebreakerEntryLocalServiceUtil} to access the icebreaker entry local service. Add custom service methods to <code>com.osp.icicle.service.impl.IcebreakerEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public IcebreakerEntry addIcebreakerEntry(
			...
			Map<Locale, String> descriptionMap, ServiceContext sc)
	...
	public IcebreakerEntry removeIcebreakerEntry(IcebreakerEntry ib)
		throws PortalException;

	public IcebreakerEntry removeIcebreakerEntry(long icebreakerEntryId)
		throws PortalException;
