...
public class IcebreakerEntryUtil {
	...
	public static IcebreakerEntry findByUuid_First(
		...
		throws com.osp.icicle.exception.NoSuchIcebreakerEntryException {
